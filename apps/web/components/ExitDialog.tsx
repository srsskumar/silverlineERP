...
export function ExitDialog({
  ...
  return (
    <div role="dialog" aria-modal="true" aria-label="Exit employee" className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
      <div className="w-full max-w-md rounded-lg bg-surface p-6 shadow-lg">
        <h2 className="text-base font-semibold text-text">
          Exit{employeeName ? ` ${employeeName}` : ' employee'}
        </h2>
        <p className="mt-1 text-sm text-text-muted">This marks the employee as exited. A reason is required.</p>
