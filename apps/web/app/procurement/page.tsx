...
import { day, money, financialTone, businessToday } from '@/lib/finance';
import { useToast } from '@/components/ui/Toast';
import { applyFieldErrors } from '@/lib/form-errors';
import {
  requisitionSchema, type RequisitionFormInput,
  purchaseOrderSchema, type PurchaseOrderFormInput,
  grnSchema, type GrnFormInput,
  rfqSchema, type RfqFormInput,
} from '@/lib/validation';
...
/** Field-level error text under an input, from RHF's `errors` object. */
 ...
 */
function NewRequisition({ onClose, onCreated }: { onClose: () => void; onCreated: (id: string) => void }) {
 ...
 */
function NewRfq({ onClose, onCreated }: { onClose: () => void; onCreated: (id: string) => void }) {
  const toast = useToast();
  const [submitError, setSubmitError] = React.useState<unknown>(null);
