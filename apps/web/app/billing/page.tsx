...
import { day, money, moneyIndian, percent, utilisationWidth, businessToday } from '@/lib/finance';
import { useToast } from '@/components/ui/Toast';
import { messageOf, applyFieldErrors } from '@/lib/form-errors';
import { RequireDestination } from '@/components/RequirePermission';
import {
  raBillSchema, type RaBillFormInput, RA_BILL_DEDUCTION_HEADS,
  advanceSchema, type AdvanceFormInput, ADVANCE_TYPES,
} from '@/lib/validation';
 ...
 * recovers it.
 */
function NewAdvance({ projectId, onClose }: { projectId: string; onClose: () => void }) {
  const toast = useToast();
  const [submitError, setSubmitError] = React.useState<unknown>(null);
