/**
 * Pure-TS geo math for S2 geo-fences. No dependencies, no I/O:
 * haversine distance for circles + ray-cast point-in-polygon with a
 * tolerance buffer (distance to the nearest edge) for polygons.
 */
