...
export async function seedDatabase(
  ...
  for (const code of ROLE_CODES) {
    ...
    const grants = new Set<string>([
      ...
      ...(SUPPLY_ROLE_GRANTS[code as RoleCode] ?? []),
    ]);
